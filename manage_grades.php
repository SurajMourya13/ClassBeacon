...
// Fetch teacher name and ID for header and filtering
$sql_teacher = "SELECT id, full_name FROM teachers WHERE user_id = ?";
...
$sql_courses = "SELECT id, course_name FROM courses WHERE teacher_id = ?";
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul>
                    ...
                    <li><a href="manage_grades.php" class="active"><i class="fa-solid fa-star"></i> Manage Grades</a></li>
                </ul>
            </nav>
        </aside>
                        ...
                        <table>
                            ...
                            <tbody>
                                <?php foreach ($students as $student): 
                                    ...
                                    // Safety check (already handled by SQL, but harmless)
